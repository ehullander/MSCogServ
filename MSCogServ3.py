...
class CogServ:
    def __init__(self):
        ...
        self.__CS['Face'] = {'params': None,
                          'url':'https://api.projectoxford.ai/face/v1.0/detect?returnFaceId=true&returnFaceLandmarks=true'}
...
class images:
    def __init__(self):
        self.urls = ['https://scontent.fsnc1-1.fna.fbcdn.net/v/t1.0-9/13043631_10208934357818419_5020610029046467727_n.jpg?oh=b21323b09c86cb2bd25b2a34ee2ee2a5&oe=586BF11E',
